...
import com.example.girus.repository.ImageRepository;
import com.example.girus.repository.ImageRepository;
...
public class ImageService {
	...
	@Autowired 
	private ImageRepository imageRepositroy;
	@Autowired
...
//	}
	...
	public Optional<ImageEntity> getimagedata(long id) {
		// TODO Auto-generated method stub
	return imageRepositroy.findById((int) id);
	}
	...
	public String deleteById(long id) {
		// TODO Auto-generated method stub
   imageRepositroy.deleteById((int) id);
